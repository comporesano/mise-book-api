...
- **Логирование и обработка ошибок** - событийные логи из репозитория и роутов (создание, отмена, конфликт слота, 404); непредвиденные ошибки ловятся глобальным handler'ом: логируется traceback, наружу уходит 500 + {"detail": "Internal server error"}.
